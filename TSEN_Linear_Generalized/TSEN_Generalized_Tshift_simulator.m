function [V,C,time,growthrate] = TSEN_Generalized_Tshift_simulator(T1,T2, c0, I, P, G, gamma0, dt, Nsteps)
%% Linear TSEN model (i.e., without branches) generalized for any number of production reactions
% 
% THIS FUNCTION TIME-EVOLVES A TSEN SYSTEM WITH TWO SEPARATE TEMPERATURES
%
...
% 7. dt = timestep size
% 8. Nsteps = number of reaction steps
%
% Outputs:
